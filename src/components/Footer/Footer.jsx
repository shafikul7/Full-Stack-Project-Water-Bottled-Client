...
const Footer = () => (
    <footer className="mt-5 footer ttm-bgcolor-darkgrey widget-footer ttm-bgimage-yes ttm-bg clearfix">
                    ...
                    <div className="col-xs-12 col-sm-6 col-md-6 col-lg-3 widget-area">
                        <div className="widget widget_text clearfix">
                            ...
                            <div className="textwidget widget-text">
                                <p>
                                    Optrica committed to provide the best services in eye care
                                ...
                                <ul className="widget_contact_wrapper">
                                    ...
                                    <li>
                                        ...
                                        <a href="mailto:info@example.com">shafikul1170@gmail.com</a>
                                    </li>
                                    <li>
                                        <i className="ttm-textcolor-skincolor fa fa-map-marker"></i>
                                        1200,Barishal,Bangladesh
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="widget widget-timing clearfix">
                            ...
                            <div className="ttm-timelist-block-wrapper">
                                <ul className="ttm-timelist-block">
                                    <li>
                                        Monday:<span className="service-time">09:00 - 17:00</span>
                                    </li>
                                    <li>
                                        Tuesday:<span className="service-time">09:00 - 17:00</span>
                                    </li>
                                    <li>
                                        Wednesday:
                                        <span className="service-time">09:00 - 17:00</span>
                                    </li>
                                    <li>
                                        Thursday:<span className="service-time">09:00 - 17:00</span>
                                    </li>
                                    <li>
                                        Friday:<span className="service-time">09:00 - 17:00</span>
                                    </li>
                                    <li>
                                        Saturday:<span className="service-time">09:00 - 14:00</span>
                                    </li>
                                    <li>
                                        Sunday:<span className="service-time">Closed</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div className="row copyright">
                    <div className="col-md-12">
                        <div className="text-center copyright-text">
                            <span>
                                Copyright © 2021 <a href="/">Water Bottles</a> . All Rights Reserved
                                by&nbsp;<a href="/">Shafikul islam</a>
                            </span>
                        </div>
                    </div>
                </div>
